...
class EntityCollections(object):
    ...
    @classmethod
    def for_application(cls, application, collections):
        return cls(parent=application, availiable_collections=collections)
        ...
        if name not in self._collection_cache:
            ...
            if isinstance(cls_or_verpick, VersionPick):
                ...
                try:
                    ...
                    # TODO Add logger
                    print("[COLLECTIONS] Is the collection %s truly a collection?", name)
            else:
                cls = cls_or_verpick
